...
vm_int32 vmp_const_datatype(vm_int32 lhs, vm_int32 rhs)
{
	static const types[VMI_INSTR_PROP_DATA_TYPE_COUNT][VMI_INSTR_PROP_DATA_TYPE_COUNT] = {
		...
		// UINT32
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_UI4, VMI_INSTR_PROP_UI4, VMI_INSTR_PROP_UI4, VMI_INSTR_PROP_UI4, VMI_INSTR_PROP_UI4,
			VMI_INSTR_PROP_UI4, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_PTR
		},
		// INT64
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_I8,
			VMI_INSTR_PROP_I8, VMI_INSTR_PROP_I8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_PTR
		},
		// UINT64
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8,
			VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_UI8, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_PTR
		},
		// FLOAT32
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4,
			VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F4, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_PTR
		},
		// FLOAT64
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8,
			VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_F8, VMI_INSTR_PROP_PTR
		},
		// PTR
		{
			0, VMI_INSTR_PROP_I4, VMI_INSTR_PROP_PTR, VMI_INSTR_PROP_PTR, VMI_INSTR_PROP_PTR, VMI_INSTR_PROP_PTR, VMI_INSTR_PROP_PTR,

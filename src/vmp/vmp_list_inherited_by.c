...
BOOL vmp_list_inherited_by_init(vmp_list_inherited_by* l)
{
	l->count = 0;
	l->capacity = CAPACITY;
...
vm_int32 vmp_list_inherited_by_add(vmp_list_inherited_by* l, vmp_type* ptr)
{
...
vmp_type* vmp_list_inherited_by_find(const vmp_list_inherited_by* l, const vm_string* name)
{
...
vmp_type* vmp_list_inherited_by_get(const vmp_list_inherited_by* l, vm_int32 index)
{
	if (l->count <= index)
		return NULL;

...
BOOL vmc_lexer_message_unclosed_comment(vmc_lexer* l)
{
...
BOOL vmc_lexer_message_unclosed_string(vmc_lexer* l)
{
	int line, line_offset, _;
	vmc_lexer_get_metadata(l, &line, &line_offset, &_);
	return vm_messages_add(&l->messages,
...
BOOL vmc_lexer_message_unknown_escaped_char(vmc_lexer* l, vm_byte rune)
{
	int line, line_offset, _;
	vmc_lexer_get_metadata(l, &line, &line_offset, &_);
	return vm_messages_add(&l->messages,

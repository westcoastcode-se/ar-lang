...
extern BOOL vmc_compiler_message_type_not_found(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_expected_keyword(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_expected_index(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_expected_int(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_expected_string(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_expected_decimal(const vmc_compiler_scope* s);
extern BOOL vmc_compiler_message_not_implemented(const vmc_compiler_scope* s);

...
enum vmi_ocodes
{
	VMI_OP_LDC_I1 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8)),
	VMI_OP_LDC_UI1 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT8)),
	VMI_OP_LDC_I2 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16)),
	VMI_OP_LDC_UI2 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT16)),
	VMI_OP_LDC_I4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32)),
	VMI_OP_LDC_UI4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT32)),
	VMI_OP_LDC_I8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64)),
	VMI_OP_LDC_UI8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT64)),
	VMI_OP_LDC_F4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32)),
	VMI_OP_LDC_F8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64)),

	VMI_OP_LDC_S_I1_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I1_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I1_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I2_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I2_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I2_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I4_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I4_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I4_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I8_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I8_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I8_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_F4_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_F4_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_F4_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_F8_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_F8_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_F8_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64) | VMI_PROPS2_OPCODE(-1)),
	...
	VMI_OP_MUL_I1 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8)),
	VMI_OP_MUL_UI1 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT8)),
	VMI_OP_MUL_I2 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16)),
	VMI_OP_MUL_UI2 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT16)),
	VMI_OP_MUL_I4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32)),
	VMI_OP_MUL_UI4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT32)),
	VMI_OP_MUL_I8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64)),
	VMI_OP_MUL_UI8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT64)),
	VMI_OP_MUL_F4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32)),
	VMI_OP_MUL_F8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64)),

	VMI_OP_DIV_I1 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT8)),
	VMI_OP_DIV_UI1 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT8)),
	VMI_OP_DIV_I2 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT16)),
	VMI_OP_DIV_UI2 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT16)),
	VMI_OP_DIV_I4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT32)),
	VMI_OP_DIV_UI4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT32)),
	VMI_OP_DIV_I8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_INT64)),
	VMI_OP_DIV_UI8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UINT64)),
	VMI_OP_DIV_F4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT32)),
	VMI_OP_DIV_F8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_FLOAT64)),

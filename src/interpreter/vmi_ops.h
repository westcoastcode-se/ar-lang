...
enum vmi_ocodes
{
	VMI_OP_LDC_I1 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_LDC_UI1 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_LDC_I2 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_LDC_UI2 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_LDC_I4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_LDC_UI4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_LDC_I8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_LDC_UI8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_LDC_F4 = (VMI_LDC | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_LDC_F8 = (VMI_LDC_I8 | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_LDC_S_I1_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I1_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I1_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I2_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I2_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I2_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I4_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I4_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I4_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_I8_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_I8_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_I8_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_F4_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_F4_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_F4_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_LDC_S_F8_0 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8) | VMI_PROPS2_OPCODE(0)),
	VMI_OP_LDC_S_F8_1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8) | VMI_PROPS2_OPCODE(1)),
	VMI_OP_LDC_S_F8_N1 = (VMI_LDC_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8) | VMI_PROPS2_OPCODE(-1)),

	VMI_OP_ADD_I1 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_ADD_UI1 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_ADD_I2 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_ADD_UI2 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_ADD_I4 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_ADD_UI4 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_ADD_I8 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_ADD_UI8 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_ADD_F4 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_ADD_F8 = (VMI_ADD | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_SUB_I1 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_SUB_UI1 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_SUB_I2 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_SUB_UI2 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_SUB_I4 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_SUB_UI4 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_SUB_I8 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_SUB_UI8 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_SUB_F4 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_SUB_F8 = (VMI_SUB | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_MUL_I1 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_MUL_UI1 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_MUL_I2 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_MUL_UI2 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_MUL_I4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_MUL_UI4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_MUL_I8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_MUL_UI8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_MUL_F4 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_MUL_F8 = (VMI_MUL | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_DIV_I1 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_DIV_UI1 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_DIV_I2 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_DIV_UI2 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_DIV_I4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_DIV_UI4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_DIV_I8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_DIV_UI8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_DIV_F4 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_DIV_F8 = (VMI_DIV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_CONV_I2_I4 = (VMI_CONV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2) | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_CONV_I4_I2 = (VMI_CONV | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4) | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I2)),
	...
	VMI_OP_COPY_S_INT32 = (VMI_COPY_S | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	...
	VMI_OP_NEG_I1 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I1)),
	VMI_OP_NEG_UI1 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI1)),
	VMI_OP_NEG_I2 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I2)),
	VMI_OP_NEG_UI2 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI2)),
	VMI_OP_NEG_I4 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I4)),
	VMI_OP_NEG_UI4 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI4)),
	VMI_OP_NEG_I8 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_I8)),
	VMI_OP_NEG_UI8 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_UI8)),
	VMI_OP_NEG_F4 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F4)),
	VMI_OP_NEG_F8 = (VMI_NEG | VMI_PROPS1_OPCODE(VMI_INSTR_PROP_F8)),

	VMI_OP_BIT_NOT_I1 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I1) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_UI1 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_UI1) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_I2 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I2) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_UI2 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_UI2) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_I4 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I4) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_UI4 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_UI4) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_I8 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_I8) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
	VMI_OP_BIT_NOT_UI8 = (VMI_BIT | VMI_PROPS2_OPCODE(VMI_INSTR_PROP_UI8) | VMI_PROPS1_OPCODE(VMI_INSTR_BIT_PROPS2_NOT)),
};
#endif

...
vmi_ip _vmi_thread_divi1(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 1 byte integers
vmi_ip _vmi_thread_divui1(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_divi2(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 2 byte integers
vmi_ip _vmi_thread_divui2(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_divi4(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 4 byte integers
vmi_ip _vmi_thread_divui4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_divi8(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 8 byte integers
vmi_ip _vmi_thread_divui8(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_divf4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_divf8(vmi_thread* t, vmi_ip ip)
{

...
vmi_ip _vmi_thread_subi1(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 1 byte integers
vmi_ip _vmi_thread_subui1(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_subi2(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 2 byte integers
vmi_ip _vmi_thread_subui2(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_subi4(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 4 byte integers
vmi_ip _vmi_thread_subui4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_subi8(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 8 byte integers
vmi_ip _vmi_thread_subui8(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_subf4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_subf8(vmi_thread* t, vmi_ip ip)
{

...
vmi_ip _vmi_thread_muli1(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 1 byte integers
vmi_ip _vmi_thread_mului1(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_muli2(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 2 byte integers
vmi_ip _vmi_thread_mului2(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_muli4(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 4 byte integers
vmi_ip _vmi_thread_mului4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_muli8(vmi_thread* t, vmi_ip ip)
{
...
// Add the two top-most values from the stack. Assume that they are 8 byte integers
vmi_ip _vmi_thread_mului8(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_mulf4(vmi_thread* t, vmi_ip ip)
{
...
vmi_ip _vmi_thread_mulf8(vmi_thread* t, vmi_ip ip)
{

...
arIP _arThread_muli1(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 1 byte integers
arIP _arThread_mului1(arThread* t, arIP ip)
{
...
arIP _arThread_muli2(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 2 byte integers
arIP _arThread_mului2(arThread* t, arIP ip)
{
...
arIP _arThread_muli4(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 4 byte integers
arIP _arThread_mului4(arThread* t, arIP ip)
{
...
arIP _arThread_muli8(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 8 byte integers
arIP _arThread_mului8(arThread* t, arIP ip)
{
...
arIP _arThread_mulf4(arThread* t, arIP ip)
{
...
arIP _arThread_mulf8(arThread* t, arIP ip)
{

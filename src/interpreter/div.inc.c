...
arIP _arThread_divi1(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 1 byte integers
arIP _arThread_divui1(arThread* t, arIP ip)
{
...
arIP _arThread_divi2(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 2 byte integers
arIP _arThread_divui2(arThread* t, arIP ip)
{
...
arIP _arThread_divi4(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 4 byte integers
arIP _arThread_divui4(arThread* t, arIP ip)
{
...
arIP _arThread_divi8(arThread* t, arIP ip)
{
...
// Add the two top-most values from the stack. Assume that they are 8 byte integers
arIP _arThread_divui8(arThread* t, arIP ip)
{
...
arIP _arThread_divf4(arThread* t, arIP ip)
{
...
arIP _arThread_divf8(arThread* t, arIP ip)
{
